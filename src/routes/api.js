...
const WEBHOOK_MAKE_PREFEITURAS = "https://hook.us2.make.com/903cplertvaer2vh3v7qn4o7qwlx8gn";
...
router.post("/registros", async (req, res) => {
  try {
    ...
    console.error("Erro ao registrar solicitação:", erro.message);
    res.status(500).json({
...
router.get("/registros/protocolo/:protocolo", async (req, res) => {
  try {
    ...
    console.error("Erro ao consultar protocolo:", erro.message);
    res.status(500).json({
